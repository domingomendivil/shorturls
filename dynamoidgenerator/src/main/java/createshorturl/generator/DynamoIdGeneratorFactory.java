...
public class DynamoIdGeneratorFactory {
	...
	private static final DynamoIdGenerator instance = init(ShortURLPropertiesImpl.getInstance());

	/*
	 * Method for creating a new instance of the DynamoIdGenerator class
	 */
	public final static DynamoIdGenerator init(final ShortURLProperties properties) {
		val client = DynamoDbClientFactory.getClient();
		val base62Encoder = new Base62EncoderImpl(); // a base62 encoder is used by default
